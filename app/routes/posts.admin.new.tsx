...
export const action = async ({ request }: ActionArgs) => {
    ...
    const errors = {
        ...
        markdown: markdown ? null : "Markdown is reguired"
    };
...
export default function postsAdminNew() {
    ...
    return (
        <Form method="post">
            ...
            <p>
                ...
                <br />
                <textarea name="markdown" id="markdown" rows={10} className={`${inputClassName} font-mono`} />
